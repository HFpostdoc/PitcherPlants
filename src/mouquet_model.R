...
####################################################################################
###                                                                              ###
###           Note to self. A new, better version of this model                  ###
###           is now in the SEELab/enaR_development folder.                      ###
###                                                                              ###
####################################################################################
####################################################################################
...
##      mode='circle',edge.lwd=log(inqC.net%e%'flow'),uselen=TRUE,edge.len=0.1)
##                                         #ascendency
